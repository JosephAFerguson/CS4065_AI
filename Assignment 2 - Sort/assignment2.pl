...
listsGeneration(N) :-
    N > 0,
    random(10000, 100000, ListSize), %change list size based on testing
...
hybridSort1(LIST, SLIST) :-
    hybridSort(LIST, insertionSort, quickSort, 4000, SLIST).
hybridSort2(LIST, SLIST) :-
    hybridSort(LIST, bubbleSort, mergeSort, 4000, SLIST).
hybridSort3(LIST, SLIST) :-
    hybridSort(LIST, insertionSort, mergeSort, 4000, SLIST).
hybridSort4(LIST, SLIST) :-
    hybridSort(LIST, bubbleSort, quickSort, 4000, SLIST).
...
run_sorts(ListNum, List) :-
    %feel free to comment out those that do not work
